(() => {
  const translations = new Map(Object.entries({
    "Research": "Forschung",
    "Research & Insights": "Forschung & Impulse",
    "About Me": "Über mich",
    "Why us": "Warum wir",
    "Services": "Leistungen",
    "Approach": "Ansatz",
    ...
    "Let's talk": "Kontakt",
    "Let’s talk": "Kontakt",
    "Better work for human-centered organizations": "Bessere Arbeit für menschenzentrierte Organisationen",
    "Helping teams build": "Teams dabei unterstützen,",
    "trust, clarity, and sustainable performance.": "Vertrauen, Klarheit und nachhaltige Leistung aufzubauen.",
    "Research-informed facilitation for organizations navigating psychological safety, Agile collaboration, cross-cultural communication, remote work, and modern work culture.": "Forschungsinformierte Begleitung für Organisationen, die psychologische Sicherheit, agile Zusammenarbeit, interkulturelle Kommunikation, Remote-Arbeit und moderne Arbeitskultur gestalten.",
    "Book a discovery call": "Kennenlerngespräch buchen",
    "Read the evidence": "Forschung lesen",
    "Clarity": "Klarheit",
    ...
    "What I help solve": "Wobei ich unterstütze",
    "Better work,": "Bessere Arbeit,",
    "healthier teams.": "gesündere Teams.",
    "Workshops and consulting for the human problems behind performance: trust, conflict, communication, belonging, and sustainable collaboration.": "Workshops und Beratung für die menschlichen Themen hinter Leistung: Vertrauen, Konflikte, Kommunikation, Zugehörigkeit und nachhaltige Zusammenarbeit.",
    "Psychological safety workshops": "Workshops zu psychologischer Sicherheit",
    "Help teams speak honestly, reduce blame, learn from mistakes, and create the trust needed for better performance.": "Teams dabei unterstützen, offen zu sprechen, Schuldzuweisungen zu reduzieren, aus Fehlern zu lernen und Vertrauen für bessere Leistung aufzubauen.",
    "Agile team health": "Agile Teamgesundheit",
    "Diagnose what is slowing collaboration, decision-making, engagement, and delivery, then turn insight into practical team experiments.": "Erkennen, was Zusammenarbeit, Entscheidungen, Engagement und Lieferung verlangsamt, und daraus praktische Teamexperimente entwickeln.",
    "Communication across cultures": "Kommunikation über Kulturen hinweg",
    "Support teams working across languages, countries, and remote contexts so more voices can influence the work.": "Teams unterstützen, die über Sprachen, Länder und Remote-Kontexte hinweg arbeiten, damit mehr Stimmen die Arbeit wirklich beeinflussen können.",
    ...
    "Agile and PSC are not the product. They are tools for helping people solve hard problems together in healthier ways.": "Agile und PSC sind nicht das Produkt. Sie sind Werkzeuge, damit Menschen schwierige Probleme gemeinsam und gesünder lösen können.",
    "Why work with me": "Warum mit mir arbeiten",
    "Research depth.": "Forschungstiefe.",
    "Human experience.": "Menschliche Erfahrung.",
    "Practical change.": "Praktische Veränderung.",
    "I bring together architecture, migration, customer-facing work, cross-cultural communication, Agile practice, PSC research, and New Work thinking.": "Ich verbinde Architektur, Migrationserfahrung, kundennahes Arbeiten, interkulturelle Kommunikation, agile Praxis, PSC-Forschung und New-Work-Denken.",
    "I understand the human side of systems": "Ich verstehe die menschliche Seite von Systemen",
    "My architecture background helps me see structures; my work across cultures helps me see the people living inside them.": "Mein Architekturhintergrund hilft mir, Strukturen zu erkennen; meine Arbeit über Kulturen hinweg hilft mir, die Menschen darin zu sehen.",
    "I translate research into practice": "Ich übersetze Forschung in Praxis",
    "PSC, psychological safety, Agile, and New Work become concrete conversations, diagnostics, workshops, and experiments.": "PSC, psychologische Sicherheit, Agile und New Work werden zu konkreten Gesprächen, Diagnosen, Workshops und Experimenten.",
    "I focus on what customers actually need": "Ich fokussiere auf das, was Kundinnen und Kunden wirklich brauchen",
    "Less theory for its own sake. More trust, clarity, reduced conflict, better communication, and sustainable performance.": "Weniger Theorie um ihrer selbst willen. Mehr Vertrauen, Klarheit, weniger Konflikte, bessere Kommunikation und nachhaltige Leistung.",
    "Research highlights": "Forschungshighlights",
    "Evidence behind": "Evidenz hinter",
    "better work.": "besserer Arbeit.",
    "My thesis and ongoing research support the practical claim: healthier ways of working help teams collaborate, adapt, and perform.": "Meine Masterarbeit und laufende Forschung stützen die praktische These: Gesündere Arbeitsweisen helfen Teams, besser zusammenzuarbeiten, sich anzupassen und Leistung zu bringen.",
    "Study base": "Studienbasis",
    "employees surveyed about psychosocial safety climate across modern work environments.": "Beschäftigte wurden zum psychosozialen Sicherheitsklima in modernen Arbeitsumgebungen befragt.",
    "Compared groups": "Verglichene Gruppen",
    "settings compared: Agile IT, Non-Agile IT, and Non-IT work environments.": "Arbeitsumgebungen wurden verglichen: Agile IT, Nicht-Agile IT und Nicht-IT.",
    "Main finding": "Zentrales Ergebnis",
    "showed the strongest climate for management support, communication, participation, and psychological safety.": "zeigte das stärkste Klima für Unterstützung durch Führung, Kommunikation, Beteiligung und psychologische Sicherheit.",
    "Practical meaning": "Praktische Bedeutung",
    "Culture": "Kultur",
    "work design and leadership practices mattered more than industry sector alone.": "Arbeitsgestaltung und Führungspraktiken waren wichtiger als die Branche allein.",
    "The research matters when it helps teams create trust, clarity, communication, and sustainable performance.": "Forschung wird dann wichtig, wenn sie Teams hilft, Vertrauen, Klarheit, Kommunikation und nachhaltige Leistung zu entwickeln.",
    "Researcher and facilitator": "Forscher und Facilitator",
    "Latest insights": "Neueste Impulse",
    "Ideas for modern,": "Ideen für moderne,",
    "human-centered work.": "menschenzentrierte Arbeit.",
    "Short research-informed reads on psychological safety, New Work, technology, diversity, remote work, and communication.": "Kurze, forschungsinformierte Texte zu psychologischer Sicherheit, New Work, Technologie, Vielfalt, Remote-Arbeit und Kommunikation.",
    "Research": "Forschung",
    "How safety, boundaries, and participation shape healthier digital collaboration.": "Wie Sicherheit, Grenzen und Beteiligung gesündere digitale Zusammenarbeit prägen.",
    "Why trust, autonomy, participation, and meaning matter for modern organizations.": "Warum Vertrauen, Autonomie, Beteiligung und Sinn für moderne Organisationen wichtig sind.",
    "Community": "Community",
    "How technology creates lasting value when it is embedded in communities and culture.": "Wie Technologie dauerhaften Wert schafft, wenn sie in Gemeinschaften und Kultur eingebettet ist.",
    "Read insight": "Impuls lesen",
    ...
    "Contact number (optional)": "Telefonnummer (optional)",
    "What would you like to change?": "Was möchten Sie verändern?",
    "Submitting opens a prepared email to Berlinagile.": "Beim Absenden öffnet sich eine vorbereitete E-Mail an Berlinagile.",
    ...
    "Survey findings": "Umfrageergebnisse",
    "Event insights": "Veranstaltungsanalyse",
    "Research in progress": "Laufende Forschung",
    "Field note": "Feldnotiz",
    "Working paper": "Arbeitspapier",
    "Experiment": "Experiment",
    "min read": "Min. Lesezeit",
    "Remote work · Inclusion": "Remote-Arbeit · Inklusion",
    "Diversity · Inclusion": "Vielfalt · Inklusion",
    "An introduction to Agile work, its emphasis on adaptability and collaboration, and the growing importance of employee well-being and psychosocial safety.": "Eine Einführung in agile Arbeit, ihren Schwerpunkt auf Anpassungsfähigkeit und Zusammenarbeit sowie die wachsende Bedeutung von Wohlbefinden und psychosozialer Sicherheit.",
    "How psychological safety and Psychosocial Safety Climate can support participation, boundaries, learning, and well-being in distributed Agile environments.": "Wie psychologische Sicherheit und Psychosocial Safety Climate Beteiligung, gesunde Grenzen, Lernen und Wohlbefinden in verteilten agilen Umgebungen unterstützen können.",
    "Why employees may experience the benefits of Psychosocial Safety Climate differently across demographic, professional, and cultural contexts.": "Warum Beschäftigte die Vorteile eines Psychosocial Safety Climate je nach demografischem, beruflichem und kulturellem Kontext unterschiedlich erleben können.",
    "A comparative survey of Agile IT, Non-Agile IT, and Non-IT workplaces examining psychological safety, management support, communication, and participation.": "Eine vergleichende Erhebung in agilen IT-, nicht-agilen IT- und Nicht-IT-Arbeitsumgebungen zu psychologischer Sicherheit, Unterstützung durch das Management, Kommunikation und Beteiligung.",
    "How trust, autonomy, participation, agile collaboration, and human-centered organizational design are reshaping modern work.": "Wie Vertrauen, Autonomie, Beteiligung, agile Zusammenarbeit und menschenzentrierte Organisationsgestaltung die moderne Arbeit verändern.",
    "Insights on AI, robotics, space, drug discovery, and the community ecosystems that turn technological progress into lasting social value.": "Erkenntnisse zu KI, Robotik, Raumfahrt, Arzneimittelforschung und den Gemeinschaften, die technologischen Fortschritt in dauerhaften gesellschaftlichen Wert verwandeln.",
    "Agile teams are diverse. Their ways of working often are not.": "Agile Teams sind vielfältig. Ihre Arbeitsweisen sind es oft nicht.",
    "Our first synthesis explores where standard Agile rituals quietly reward one communication style, one cultural norm, and one idea of participation.": "Unsere erste Synthese untersucht, wo etablierte agile Rituale unbemerkt einen bestimmten Kommunikationsstil, eine kulturelle Norm und eine Form der Beteiligung bevorzugen.",
    "See what we understand so far": "Unseren bisherigen Erkenntnisstand ansehen",
    "Known": "Bekannt",
    "Learning": "Lernfeld",
    "Testing": "Erprobung",
    "Remote does not create silence. It makes existing silence easier to miss.": "Remote-Arbeit erzeugt keine Stille. Sie macht vorhandene Stille leichter übersehbar.",
    "Four signals that tell us when distributed team members are present in the call but absent from the decision.": "Vier Signale dafür, dass verteilte Teammitglieder im Gespräch anwesend, an der Entscheidung aber nicht beteiligt sind.",
    "Read the note": "Notiz lesen",
    "Fluency is not the same as clarity.": "Sprachgewandtheit ist nicht dasselbe wie Klarheit.",
    "How fast conversation, idioms, and facilitation habits shape whose ideas survive multilingual meetings.": "Wie schnelles Sprechen, Redewendungen und Moderationsgewohnheiten beeinflussen, wessen Ideen in mehrsprachigen Meetings bestehen.",
    "Read the working paper": "Arbeitspapier lesen",
    "Belonging needs evidence, not intention.": "Zugehörigkeit braucht Belege, nicht nur Absichten.",
    "A lightweight retrospective check that reveals who can challenge, influence, and change the team's direction.": "Ein einfacher Retrospektiven-Check, der sichtbar macht, wer die Richtung eines Teams hinterfragen, beeinflussen und verändern kann.",
    "Try the experiment": "Experiment ausprobieren",
    "No notes in this topic yet.": "Zu diesem Thema gibt es noch keine Notizen.",
  ...
  document.querySelectorAll(".article-meta").forEach((meta) => {
    meta.childNodes.forEach((child) => {
      if (child.nodeType !== Node.TEXT_NODE) return;
      child.nodeValue = child.nodeValue
        .replace("Introduction", "Einführung")
        .replace("Research overview", "Forschungsüberblick")
        .replace("Survey findings", "Umfrageergebnisse")
        .replace("Event insights", "Veranstaltungsanalyse")
        .replace("Research in progress", "Laufende Forschung")
        .replace("Field note", "Feldnotiz")
        .replace("Working paper", "Arbeitspapier")
        .replace("min read", "Min. Lesezeit");
    });
  });
